...
static inline zn_status_t syscall0(arg_t num) {
...
static inline zn_status_t syscall1(arg_t num, arg_t a0) {
    register arg_t rnum asm(ASM_REG_NUM) = num;
    register arg_t value asm(ASM_REG_RET);
...
static inline zn_status_t syscall2(arg_t num, arg_t a0, arg_t a1) {
    register arg_t rnum asm(ASM_REG_NUM) = num;
    register arg_t value asm(ASM_REG_RET);
    register arg_t r0 asm(ASM_REG_A0) = a0;
...
static inline zn_status_t syscall3(arg_t num, arg_t a0, arg_t a1, arg_t a2) {
    register arg_t rnum asm(ASM_REG_NUM) = num;
    register arg_t value asm(ASM_REG_RET);
    register arg_t r0 asm(ASM_REG_A0) = a0;
    register arg_t r1 asm(ASM_REG_A1) = a1;
...
static inline zn_status_t syscall4(arg_t num, arg_t a0, arg_t a1, arg_t a2, arg_t a3) {
    register arg_t rnum asm(ASM_REG_NUM) = num;
    register arg_t value asm(ASM_REG_RET);
    register arg_t r0 asm(ASM_REG_A0) = a0;
    register arg_t r1 asm(ASM_REG_A1) = a1;
...
static inline zn_status_t syscall5(arg_t num, arg_t a0, arg_t a1, arg_t a2, arg_t a3, arg_t a4) {
    register arg_t rnum asm(ASM_REG_NUM) = num;
    register arg_t value asm(ASM_REG_RET);
    register arg_t r0 asm(ASM_REG_A0) = a0;
    register arg_t r1 asm(ASM_REG_A1) = a1;
...
static inline zn_status_t syscall6(arg_t num, arg_t a0, arg_t a1, arg_t a2, arg_t a3, arg_t a4, arg_t a5) {
    register arg_t rnum asm(ASM_REG_NUM) = num;
    register arg_t value asm(ASM_REG_RET);
    register arg_t r0 asm(ASM_REG_A0) = a0;
    register arg_t r1 asm(ASM_REG_A1) = a1;
